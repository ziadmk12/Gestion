          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <label for="exampleInputEmail1">Date add</label>
                  <input value="<?php echo $Categorie->date_add ?>" name="dateadd" id="dateadd" type="date" class="form-control"  >
...
url : 'http://localhost:8080/Gestion/admin/api/update_categories.php',
type : 'POST',
contentType: false,
cache: false,
processData:false,
